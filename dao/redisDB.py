...
class Redis:
    ...
    def execute(self, action, *args, raise_error: bool = True, **kwargs) -> dict:
...
if __name__ == '__main__':
    ...
    # # string
    # result = execute('set', 'key_string', 11, db_name=15, use_pool=False)
    # result = execute('get', 'key_string', db_name=15, use_pool=False)         # 获取单个
    # result = execute('mget', ['key_string', ], db_name=15, use_pool=False)    # 获取指定的多个key
